...
@click.pass_context
def joydivision(ctx, inputfile, row_interval, col_interval, scaling_factor, nodata_set, gtype):
    '''
    LOVE\n
        WILL\n
            TEAR\n
                US\n
                    APART'''
    jd.joydivision(inputfile, row_interval, col_interval, scaling_factor, nodata_set, gtype)
